...
code={selectedCurrency?.code}
 />
        ...
        <View >
            ...
            <Text 
            style={{color: selectedCurrency?.type == "I" ? COLORS.green : COLORS.red,
            ...FONTS.body3
...
style={{
    ...
    categories={{
        // Values are hardcoded for x & y axis, we can make it dynamic
...
/>
    ...
    return (
        <SafeAreaView style={{flex:1,backgroundColor: COLORS.lightGray, marginTop:StatusBar.currentHeight}}>
